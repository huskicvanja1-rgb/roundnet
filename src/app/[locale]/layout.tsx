...
import { generateWebsiteJsonLd, serializeJsonLd } from '@/lib/seo/jsonld';
import '../globals.css';
          ...
          <footer className="bg-gray-900 text-gray-300 mt-auto">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div className="md:col-span-2">
                  ...
                  <p className="text-sm text-gray-400 max-w-md">
                    {(messages as any).footer?.tagline || 'Finding your Roundnet community across Europe'}
                  </p>
                </div>
              ...
              <div className="mt-8 pt-8 border-t border-gray-800 text-sm text-gray-500 text-center">
                {((messages as any).footer?.copyright || '© {year} Roundnet Directory Europe').replace(
                  '{year}',
